...
Note that while COLOLINKS is included in the releases, The source code of the game is still not open for the fact that online leaderboards
feature may still work therefore it would be wrong to release source code that includes API key exposed into public but owever the
documentation and a custom theme mod I made for the game can be found in the `COLOLINKS` folder as well.
